...
public class DoiMatKhau extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pictures/Hinh/admin.jpg"))); // NOI18N
        ...
        btnLuu.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        ...
        btnThoat.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtMKmoi, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        // TODO add your handling code here:
        String tenDangNhap = UserSession.getUsername(); // hoặc truyền từ MainForm
        ...
        if (matKhauCu.equals(matKhauMoi)) {
            JOptionPane.showMessageDialog(this, "Mật khẩu mới không được trùng mật khẩu cũ.", "Thông báo", JOptionPane.WARNING_MESSAGE);
            return;
        }

        try {
            URL url = new URL("http://localhost:1234/api/taikhoan/doimatkhau");
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Lỗi kết nối đến máy chủ", "Lỗi", JOptionPane.ERROR_MESSAGE);
        }
