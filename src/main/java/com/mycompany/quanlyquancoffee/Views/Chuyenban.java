...
public class Chuyenban extends javax.swing.JFrame {
   ...
   private void loadChiTietBanChuyen(String maBan) {
    try {
        HoaDonChiTietDTO hd = ApiHoaDon.layHoaDonHomNayTheoBan(maBan);
        if (hd == null) {
            JOptionPane.showMessageDialog(this, "Không tìm thấy hóa đơn cho bàn chuyển.");
            return;
        }
        ...
        tblchitetban2.setModel(model);
        txtmahdbanchyen.setText(hd.getMaHd());

    } catch (IOException ex) {
        Logger.getLogger(Chuyenban.class.getName()).log(Level.SEVERE, null, ex);
        JOptionPane.showMessageDialog(this, "Không thể tải chi tiết hóa đơn của bàn chuyển.");
    }
}
...
private void clearFormSauChuyenBan() {
    ...
    private void btnGhepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGhepActionPerformed
        ...
        try {
            ...
            loadChiTietBanChuyen(maBanDich);
    ...
    private void btnChuyenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChuyenActionPerformed
        ...
        try {
            ...
            ApiHoaDon.chuyenBanHoanToan(maHdCu, maBanCu, maBanMoi, UserSession.getMaNV()); // ⚠️ thay bằng mã NV đăng nhập
